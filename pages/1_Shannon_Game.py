...
if "shannon_game" not in session_state:
    session_state.shannon_game = dict()
    session_state.shannon_game["hidden_paragraph"] = ""
    session_state.shannon_game["clean_paragraph"] = ""
    session_state.shannon_game["guessed_letters"] = set()
    session_state.shannon_game["source_book"] = ""
    session_state.shannon_game["paragraph_num"] = 0
...
if not session_state.shannon_game["hidden_paragraph"]:
    ...
    session_state.shannon_game["hidden_paragraph"] = hidden_paragraph
    session_state.shannon_game["clean_paragraph"] = clean_paragraph
    session_state.shannon_game["guessed_letters"] = set()
    session_state.shannon_game["source_book"] = book_selector
    session_state.shannon_game["paragraph_num"] = paragraph_picker
...
hidden_paragraph = session_state.shannon_game["hidden_paragraph"]
clean_paragraph = session_state.shannon_game["clean_paragraph"]
source_book = session_state.shannon_game["source_book"]
paragraph_num = session_state.shannon_game["paragraph_num"]
guessed_letters = session_state.shannon_game["guessed_letters"]
...
if clean_paragraph[next_letter_to_guess] == next_letter:
    ...
    session_state.shannon_game["hidden_paragraph"] = hidden_paragraph
    guessed_letters = set()
    session_state.shannon_game["guessed_letters"] = guessed_letters
